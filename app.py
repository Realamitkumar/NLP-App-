...
class NLPApp:
    ...
    def login_gui(self):
        ...
        heading.configure(font=('verdana',23,'bold'))

        label = Label(self.root,text='Enter Email')
        label.pack(pady=(10,10))
        label.configure(font=('verdana',23,'bold'))
        ...
        label2.configure(font=('verdana', 23, 'bold'))
        ...
        register_btn = Button(self.root, text='Register', width=30, height=2, command=self.register_gui)
    ...
    def register_gui(self):
        ...
        label = Label(self.root, text='Enter Name')
        label.pack(pady=(10, 10))
        label.configure(font=('verdana', 23, 'bold'))
        ...
        label1.configure(font=('verdana', 23, 'bold'))
    ...
    def ner(self):
        ...
        heading2 = Label(self.root, text='NER Analysis', bg='#34495E', fg='white')
        heading2.pack(pady=(10, 20))
        heading2.configure(font=('verdana', 20))
        ...
        ner_btn = Button(self.root, text='Analyze Sentiment')
        ner_btn.pack(pady=(10, 10))
